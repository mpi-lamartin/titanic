...
- Réfléchir aux attributs à utiliser (certains ne sont peut-être pas utiles). Regarder des statistiques sur les données. Convertir les données en vecteurs. Standardiser les données. Séparer les données d'entraînements pour tester.
